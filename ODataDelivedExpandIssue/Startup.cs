...
namespace ODataDelivedExpandIssue
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = @"Server=(localdb)\mssqllocaldb;Database=ODataDelivedExpandIssue;Trusted_Connection=True;ConnectRetryCount=0";
